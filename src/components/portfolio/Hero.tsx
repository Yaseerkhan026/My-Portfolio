...
export function Hero({ name, designation, tagline, introduction }: HeroProps) {
  return (
    <section className="pt-32 pb-20 px-6 overflow-hidden relative min-h-[60vh] flex items-center">
      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
        <div className="space-y-4">
          ...
          <div className="flex justify-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 fill-mode-both">
            <p className="font-headline text-2xl md:text-3xl font-medium text-muted-foreground max-w-2xl px-4 py-2 bg-accent/5 rounded-full border border-accent/10">
              {designation}
            </p>
          </div>
        </div>

        <p className="text-xl leading-relaxed text-muted-foreground max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-10 duration-700 delay-700 fill-mode-both">
          {introduction}
        </p>
